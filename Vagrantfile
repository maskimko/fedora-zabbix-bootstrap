...
Vagrant.configure(2) do |config|
  ...
  ##config.vm.synced_folder ".", "/vagrant", id: "core", :nfs => true, :mount_options => ['nolock,vers=3']
  ...
  config.vm.provider :libvirt do |libvirt|
      ...
      libvirt.host = "fedora.msk.pp.ua"
      libvirt.memory = 2048
      libvirt.cpus = 2
      #libvirt.cmd_line = "selinux=0"
  end
  ...
  #config.vm.provision "chef_solo" do |chef|
   #  chef.add_recipe "app-cookbook"
   #  chef.add_recipe "zabbix-monitor"
